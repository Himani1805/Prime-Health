...
const CreatePrescriptionModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleTemplateSelect = (templateMedicines) => {
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded hover:bg-blue-200 flex items-center gap-1 font-medium transition"
                      >
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className={`px-4 md:px-6 py-2 text-white bg-teal-600 hover:bg-teal-700 rounded-lg flex items-center transition text-sm md:text-base ${submitting ? 'opacity-70 cursor-not-allowed' : ''
                      }`}
                  >
